  ...
  <div class="login-container" style="background-color: #232323;">
    ...
    <div class="auth-main-container" style="background-color: #232323;">
      <el-row :gutter="12" type="flex" justify="center" align="top" style="max-height: calc(100%-100px);">
        ...
        >
          <h1 style="color: #BDBDBD;" >Sports Register<sup class="heading-sub"></sup></h1>
          <div style="width: 400px; margin: 0 auto; text-align: left; background-color: #232323;">
            <el-form ref="form" :model="form" style="text-align: center;" autocomplete="on">
              ...
              <div style="width: 400px; margin: 20px auto; display: flex; justify-content: space-between;">
                <div>
                  <router-link to="/" style="margin: 0; color: #707070; font-family: Helvetica; font-size: 14px">Alreadyy a member?</router-link>
                </div>
              </div>
              <el-button :loading="loading" type="primary" style="background-color: #F6B233; " class="form-button" @click.native.prevent="handleRegister">Sign Up</el-button>
            </el-form>
